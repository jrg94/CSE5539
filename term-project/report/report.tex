...
\begin{table}[tb]
  ...
  \midrule
    ...
    stsc & - \\
    stsd & - \\
    esds & the elementary stream descriptor \\
    stsz & the sample size table \\
    stts & - \\
    tkhd & the track header \\
    meta & - \\
    ilst & - \\
    cpil & - \\
    gnre & the content genre (i.e. rock) \\
    rtng & the content rating (i.e. explicit) \\
    stik & - \\
    mdat & - \\
    frma & - \\
  \midrule
